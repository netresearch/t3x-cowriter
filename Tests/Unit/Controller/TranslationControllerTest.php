...
final class TranslationControllerTest extends TestCase
{
    ...
    #[Test]
    public function translateActionReturns401ErrorMessage(): void
    {
        $this->rateLimiterStub->method('checkLimit')
            ->willReturn(new RateLimitResult(true, 20, 19, time() + 60));
    ...
    #[Test]
    public function translateActionReturns429ErrorMessage(): void
    {
        $this->rateLimiterStub->method('checkLimit')
            ->willReturn(new RateLimitResult(true, 20, 19, time() + 60));

        $this->translationServiceStub->method('translate')
            ->willThrowException(new RuntimeException('HTTP 429 rate limit exceeded'));
    ...
    #[Test]
    public function translateActionReturnsGenericErrorForUnknownException(): void
    {
        $this->rateLimiterStub->method('checkLimit')
            ->willReturn(new RateLimitResult(true, 20, 19, time() + 60));
    ...
    #[Test]
    public function translateActionOmitsStatusUrlWhenBuildUriFromRouteThrows(): void
    {
        $this->rateLimiterStub->method('checkLimit')
            ->willReturn(new RateLimitResult(true, 20, 19, time() + 60));
        ...
        $backendUriBuilderStub = $this->createStub(BackendUriBuilder::class);
        $backendUriBuilderStub->method('buildUriFromRoute')
    ...
    #[Test]
    public function translateActionHandlesNoDefaultLlmConfigurationMessage(): void
    {
        $this->rateLimiterStub->method('checkLimit')
            ->willReturn(new RateLimitResult(true, 20, 19, time() + 60));

        $this->translationServiceStub->method('translate')
            ->willThrowException(new RuntimeException('No default LLM configuration found'));
